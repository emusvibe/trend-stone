...
<!-- header -->
	<?php include "../vclassFiles/includes/portal/header.php"; ?>
<!-- end of header -->

<div class="row" style="margin: 15px;">
	<div class="col-md-3">
		<?php include "../vclassFiles/includes/portal/sidebar.php"; ?>
	</div>
	<div class="col-md-9">
		<div class="row" style="margin: 15px;">        
		       <?php 
                       if(isset($_GET['intro_to_forex'])){
				 $vclass->loadContentUserBeginer();
				}else{
				$vclass->loadContentUserAdvanced();
				}                        
