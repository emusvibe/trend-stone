<?php 
	$details=$this->getFullDetailsPid($_SESSION['vclassadmin'],"admin_details");
	$details1=$this->getFullDetailsPid($_SESSION['vclassadmin'],"admin_login");
?>
			...
			<div class="modal-body">
				<form method="post" action="#" class="form well" id="profileForm">
					<div class="form-group">
						...
						<input type="hidden" id="username" name="username" class="form-control" placeholder="User Name" value="<?php echo $details1[2]; ?>" required autofocus/>
                                                <?php echo $details1[2]; ?>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="email" id="email" name="email" class="form-control" placeholder="Email" value="<?php echo $details[3]; ?>" required>
					</div>
					<div class="form-group">
...
<?php 
	if(isset($_POST['updateBtn'])){
		$this->updateAdminProfile2($_SESSION['vclassadmin'],$_POST['username'],$_POST['fullname'],$_POST['email'],$_POST['mobileNo']);
	}
?>
