...
<div class="row" style="margin-top: 15px;">
	<div class="panel panel-default" style="border: 1px solid black;">
            <div class="panel-heading bgblue" style="background-color: #035888;">
              <h3 class="panel-title bgblue"><span class="glyphicon glyphicon-user"></span> Analyst User Details</h3>
            </div>
            <div class="panel-body">
                <hr style='height: 0px; margin: 7px;'/>       
                <center><a href="#profilePic" data-toggle="modal" style="text-decoration: none;"><img src="../consultant/uploads/images/<?php echo $dp[2]; ?>" class='img-circle img-rounded' style="width: 100px; height: auto;"></a></center>
                <hr style='height: 0px; margin: 7px;'/>
              	<?php echo $details[2]; ?>
              	<hr style='height: 0px; margin: 7px;'/>
              	<?php echo $details[3]; ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="?dashboard" class="form" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <center><img id="displayImg" src="../consultant/uploads/images/<?php echo $dp[2]; ?>" style="width: 150px; height: auto"/></center>
              </div>
              <div class="form-group">
