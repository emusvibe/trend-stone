<?php
    if(!isset($_SESSION['useredit'])){
        ...
        $details=$this->getFullDetailsPid($_SESSION['useredit'],"admin_login");
        $details1=$this->getFullDetailsPid($_SESSION['useredit'],"admin_details");
    }
?>
            ...
            <div class="modal-body">
                <form method="post" action="?users&edit" class="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" name="fullname" placeholder="Full Name" class="form-control" value="<?php echo $details1[1]; ?>" required/>
                    </div>
                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" id="email" name="email" value="<?php echo $details1[2]; ?>" placeholder="Email" class="form-control" required/>
                    </div>
                    <div class="form-group">
