...
<?php 
	if(isset($_POST['addUserBtn'])){
		...
		$this->activateAccount($_POST['activateBtn'],1,"admin_login");
	}elseif(isset($_POST['deactivateBtn'])){
		$this->activateAccount($_POST['deactivateBtn'],0,"admin_login");
	}elseif(isset($_POST['deleteBtn'])){
		$this->deleteUserAccount($_POST['deleteBtn'],"admin_login");
	}elseif(isset($_POST['chngpwdBtn'])){
		$this->resetUserPassword($_POST['user'],$_POST['password'],"admin_login");
	}
?>
