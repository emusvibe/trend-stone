<?php 
	$details=$vclass->getFullDetailsPid($_SESSION['vclassuser'],"student_details");
	$pwd=$vclass->getLastPassChng($_SESSION['vclassuser']);
        $dp=$vclass->getFullDetailsPid($_SESSION['vclassuser'],"dp");
?>
<div class="row" style="margin-top: 15px;">
	<div class="panel panel-default" style="border: 1px solid black;">
            <div class="panel-heading bgblue" style="background-color: #035888;">
              <h3 class="panel-title bgblue"><span class="glyphicon glyphicon-user"></span>  User Details</h3>
            </div>
            <div class="panel-body">
                <hr style='height: 0px; margin: 7px;'/>
                <center><a href="#profilePic" data-toggle="modal" style="text-decoration: none;" data-placement="bottom" data-toggle="tooltip" title="Change Profile Picture"><img src="../vclass/uploads/images/<?php echo $dp[2]; ?>" class='img-circle img-rounded' style="width: 100px; height: auto;"></a></center>
                <hr style='height: 0px; margin: 7px;'/>
              	<?php echo $details[2]; ?>
              	<hr style='height: 0px; margin: 7px;'/>
              	<?php echo $details[3]; ?>
    ...
    <div class="panel panel-default" style="border: 1px solid black;">
            ...
            <div class="panel-body">
              <?php echo $vclass->getLastLogin($_SESSION['vclassuser']); ?>
            </div>
    </div>
    <div class="panel panel-default" style="border: 1px solid black;">
            <div class="panel-heading bgblue" style="background-color: #035888;">
